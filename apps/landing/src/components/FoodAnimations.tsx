    ...
    <div className="relative w-full aspect-square">
      ...
      >
        <svg viewBox="0 0 200 200" className="w-full h-full drop-shadow-2xl">
          ...
          {/* Tomato sauce */}
          <circle cx="100" cy="100" r="78" fill="#bb1e10" />
  ...
  return (
    <div className="relative w-full aspect-square">
      ...
      <svg viewBox="0 0 150 150" className="w-full h-full">
        ...
        {/* Tomato sauce */}
        <circle cx="65" cy="88" r="6" fill="#bb1e10" opacity="0.8" />
        <circle cx="85" cy="92" r="5" fill="#bb1e10" opacity="0.7" />
        <circle cx="75" cy="85" r="4" fill="#bb1e10" opacity="0.6" />
  ...
  return (
    <div className="relative w-full aspect-[4/3]">
      <svg viewBox="0 0 160 120" className="w-full h-full drop-shadow-xl">
        ...
        >
          <circle cx="40" cy="72" r="12" fill="#bb1e10" />
          <circle cx="40" cy="72" r="8" fill="#E63946" />
          <circle cx="80" cy="70" r="12" fill="#bb1e10" />
          <circle cx="80" cy="70" r="8" fill="#E63946" />
          <circle cx="120" cy="72" r="12" fill="#bb1e10" />
      ...
      >
        <svg viewBox="0 0 30 50" className="w-8 h-12">
          ...
          <path d="M15,5 L28,12 L15,19 Z" fill="#bb1e10" />
        </svg>
      </motion.div>
    </div>
  )
...
export const PizzaSlice = ({ className = '' }: { className?: string }) => (
  ...
  >
    ...
    <path d="M30,10 L50,70 L10,70 Z" fill="#bb1e10" />
...
export const DrinkAnimation = ({ className = '' }: { className?: string }) => (
  ...
  >
    <svg viewBox="0 0 60 100" className="w-full h-full">
      ...
      {/* Straw */}
      <rect x="35" y="5" width="4" height="80" rx="2" fill="#bb1e10" />
