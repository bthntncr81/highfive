            ...
            <div className="relative h-[500px]">
              ...
              >
                <div className="bg-white rounded-2xl overflow-hidden shadow-lg">
                  <div className="aspect-[4/3] bg-surface overflow-hidden">
                    <img
                      src={content.menu.items[0]?.image}
                      alt={content.menu.items[0]?.name}
                  ...
                  <div className="p-4">
                    <div className="flex items-center justify-between">
                      <h3 className="font-display font-bold text-foreground">
                        {content.menu.items[0]?.name}
                      </h3>
                      <span className="font-display font-bold text-primary">
                        ₺{content.menu.items[0]?.price}
                      </span>
                    </div>
                    <p className="text-sm text-foreground-muted mt-1 line-clamp-1">
                      {content.menu.items[0]?.desc}
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-white rounded-2xl overflow-hidden shadow-lg">
                  <div className="aspect-[4/3] bg-surface overflow-hidden">
                    <img
                      src={content.menu.items[1]?.image}
                      alt={content.menu.items[1]?.name}
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div className="p-4">
                    <div className="flex items-center justify-between">
                      <h3 className="font-display font-bold text-foreground text-sm">
                        {content.menu.items[1]?.name}
                      </h3>
                      <span className="font-display font-bold text-primary text-sm">
                        ₺{content.menu.items[1]?.price}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="bg-white rounded-2xl overflow-hidden shadow-lg">
                  <div className="aspect-[4/3] bg-surface overflow-hidden">
                    <img
                      src={content.menu.items[2]?.image}
                      alt={content.menu.items[2]?.name}
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div className="p-4">
                    <div className="flex items-center justify-between">
                      <h3 className="font-display font-bold text-foreground text-sm">
                        {content.menu.items[2]?.name}
                      </h3>
                      <span className="font-display font-bold text-primary text-sm">
                        ₺{content.menu.items[2]?.price}
                      </span>
                    </div>
                  </div>
                </div>
