...
import { HfPizza, HfSandwich } from '../components/BrandIcons'
...
export default function Builder() {
  ...
  const handleAddToCart = () => {
    ...
    // Layered preview için: base + her ingredient'in layerImage URL'i (sıralı)
    const previewLayers = selectedIngredients
      .map((i) => imageUrl(i.layerImage))
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="text-6xl animate-pulse">{isPizza ? <HfPizza className="w-16 h-16" /> : <HfSandwich className="w-16 h-16" />}</div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6">
        <div className="text-center max-w-md">
          <div className="text-7xl">{isPizza ? <HfPizza className="w-16 h-16" /> : <HfSandwich className="w-16 h-16" />}</div>
        ...
        <div className="container-diner py-3 flex items-center justify-between">
          ...
          <h1 className="text-base font-display font-extrabold flex-1 text-center mx-3 truncate">
            <span className="inline-flex items-center justify-center gap-1.5">
              {isPizza ? <HfPizza className="w-5 h-5" /> : <HfSandwich className="w-5 h-5" />}
                ...
                >
                  ...
                  >
                    {url ? (
                      ...
                      <div className="text-5xl">{isPizza ? <HfPizza className="w-16 h-16" /> : <HfSandwich className="w-16 h-16" />}</div>
                    )}
                  </div>
